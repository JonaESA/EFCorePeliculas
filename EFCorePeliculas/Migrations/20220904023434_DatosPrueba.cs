...
namespace EFCorePeliculas.Migrations
{
    public partial class DatosPrueba : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameColumn(
                name: "Generosidentificador",
                table: "GeneroPelicula",
                newName: "GenerosIdentificador");
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2022, 9, 10, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2022, 9, 3, 0, 0, 0, 0, DateTimeKind.Local), 10m },
                    { 2, 4, new DateTime(2022, 9, 8, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2022, 9, 3, 0, 0, 0, 0, DateTimeKind.Local), 15m }
                });
